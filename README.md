...
- It is a web based image caption generator where you can generate caption for any image. The model on the backend is constructed with the combination of CNN(VGG16) and RNN(LSTM) for my fyp<br>
